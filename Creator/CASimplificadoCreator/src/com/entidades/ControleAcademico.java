...
public class ControleAcademico{
    ...
    public ControleAcademico() { //agrg turma,alunos e profs
   ...
   //cadastrar um professor no CA
    public boolean addProfessorCA(String nome, int id) {
    ...
    //cadastrar aluno no CA
    public boolean addAlunoCA(String nome, int matricula, String curso) {
    ...
    //Faz o cadastro do  aluno na disciplina
    ...
    //Realiza busca na lista da turma da disciplina
    ...
    //Faz a atribuição de um professor na disciplina
